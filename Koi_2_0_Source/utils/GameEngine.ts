...
export class GameEngine {
    ...
    private theme: PondTheme = PondTheme.DEFAULT; // Default theme
    ...
    private draw() {
        ...
        this.kois.forEach(entity => {
            ...
            try {
                // Calculate spotPhenotype if available
                const spotPhenotype = entity.data.genetics.spotPhenotypeGenes
                    ? calculateSpotPhenotype(entity.data.genetics.spotPhenotypeGenes, entity.data)
                    : undefined;
                entity.renderer.drawWorld(this.ctx, colors, entity.cachedColors.spots, isSelected, Date.now(), spotPhenotype);
            } catch (e) {
